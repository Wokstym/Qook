...
class IngredientAdapter(private val objects: List<IngredientDto>) : RecyclerView.Adapter<IngredientAdapter.IngredientViewHolder>() {
    ...
    inner class IngredientViewHolder(private val binding: ItemIngredientBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(ingredient: IngredientDto) {
            ...
            binding.ingredientUnit.text = ingredient.unit.polishName
        }
    }
}